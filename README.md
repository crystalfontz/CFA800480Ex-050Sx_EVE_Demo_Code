...
2. In the Image Utilities tool, use the "ADD" button to load the image
3. Set the output format to "ASTC" and ASTC Preset to "thorough" and "8x8"
4. Click Convert
5. Switch to the Asset Compressor tab and load the .RAW file generated by the image utility
6. Click Convert
7. Change the extension from .zlib to .a8z
8. The file names are hard coded in the firmware. These names can be found starting on line 104 of demos.cpp
...
7. Adjust the demo defines to enable desired demos.
