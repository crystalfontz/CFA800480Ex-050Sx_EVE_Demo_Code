...
3. Set the output format to "ASTC" and ASTC Preset to "thorough" abd "8x8"
4. Click Convert
5. Switch to the Asset Compressor tab, load the .RAW file generated by the image utility and hit convert
6. Change the extension from .zlib to .a8z
7. The file names are hard coded in the firmware. These names can be found starting on line 104 of demos.cpp
